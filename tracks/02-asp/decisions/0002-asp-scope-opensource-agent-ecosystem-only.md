...
Представь, что мы пишем правила, по которым AI-помощники смогут лазить по чужому коду и находить там нужное. На рынке такие помощники бывают двух типов:

- **Платные** (Cursor, Claude Code и подобные) — их делают крупные компании.
- **Бесплатные с открытым кодом** (Aider, Continue, Cline) — их пишут энтузиасты, и любой человек может посмотреть и улучшить.

Решение: **пишем правила только для бесплатных**. Платные смогут подключиться позже, если сами захотят. Почему так: с авторами бесплатных можно списаться через сайт за пару дней. С платными надо договариваться с их юристами — это занимает месяцы, а у нас нет ни времени, ни денег на такие переговоры.
